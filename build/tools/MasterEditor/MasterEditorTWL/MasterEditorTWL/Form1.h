...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->stripFile->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(9) {this->stripItemOpenRom, 
				this->stripItemSepFile1, this->stripItemSaveTemp, this->stripItemLoadTemp, this->toolStripSeparator2, this->stripItemRomInfoList, 
				this->toolStripSeparator1, this->stripItemErrorListRead, this->stripItemErrorListCurrent});
...
#pragma endregion
	...
	private:
		...
		// XML形式のリストを作成
		System::Void makeRomInfoListXml(System::Xml::XmlDocument^ doc);

		// HTML形式で保存
		System::Void makeRomInfoListHtml(System::String ^filepath);
	...
	private:
		System::Void stripItemRomInfoList_Click(System::Object^  sender, System::EventArgs^  e)
		{
			...
			try
			{
				this->makeRomInfoListHtml(filename);
			}
			catch( System::Exception ^ex )
			{
				(void)ex;
