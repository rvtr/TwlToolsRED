...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labCountryCodeR = (gcnew System::Windows::Forms::Label());
			this->combCountryCode = (gcnew System::Windows::Forms::ComboBox());
			this->labCountryCodeL = (gcnew System::Windows::Forms::Label());
			...
			this->tabSubmitInfo->Controls->Add(this->labCountryCodeR);
			this->tabSubmitInfo->Controls->Add(this->combCountryCode);
			this->tabSubmitInfo->Controls->Add(this->labCountryCodeL);
			...
			// labCountryCodeR
			// 
			this->labCountryCodeR->AccessibleDescription = nullptr;
			this->labCountryCodeR->AccessibleName = nullptr;
			resources->ApplyResources(this->labCountryCodeR, L"labCountryCodeR");
			this->labCountryCodeR->Name = L"labCountryCodeR";
			// 
			// combCountryCode
			// 
			this->combCountryCode->AccessibleDescription = nullptr;
			this->combCountryCode->AccessibleName = nullptr;
			resources->ApplyResources(this->combCountryCode, L"combCountryCode");
			this->combCountryCode->BackgroundImage = nullptr;
			this->combCountryCode->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			this->combCountryCode->Font = nullptr;
			this->combCountryCode->FormattingEnabled = true;
			this->combCountryCode->Items->AddRange(gcnew cli::array< System::Object^  >(27) {resources->GetString(L"combCountryCode.Items"), 
				resources->GetString(L"combCountryCode.Items1"), resources->GetString(L"combCountryCode.Items2"), resources->GetString(L"combCountryCode.Items3"), 
				resources->GetString(L"combCountryCode.Items4"), resources->GetString(L"combCountryCode.Items5"), resources->GetString(L"combCountryCode.Items6"), 
				resources->GetString(L"combCountryCode.Items7"), resources->GetString(L"combCountryCode.Items8"), resources->GetString(L"combCountryCode.Items9"), 
				resources->GetString(L"combCountryCode.Items10"), resources->GetString(L"combCountryCode.Items11"), resources->GetString(L"combCountryCode.Items12"), 
				resources->GetString(L"combCountryCode.Items13"), resources->GetString(L"combCountryCode.Items14"), resources->GetString(L"combCountryCode.Items15"), 
				resources->GetString(L"combCountryCode.Items16"), resources->GetString(L"combCountryCode.Items17"), resources->GetString(L"combCountryCode.Items18"), 
				resources->GetString(L"combCountryCode.Items19"), resources->GetString(L"combCountryCode.Items20"), resources->GetString(L"combCountryCode.Items21"), 
				resources->GetString(L"combCountryCode.Items22"), resources->GetString(L"combCountryCode.Items23"), resources->GetString(L"combCountryCode.Items24"), 
				resources->GetString(L"combCountryCode.Items25"), resources->GetString(L"combCountryCode.Items26")});
			this->combCountryCode->Name = L"combCountryCode";
			// 
			// labCountryCodeL
			// 
			this->labCountryCodeL->AccessibleDescription = nullptr;
			this->labCountryCodeL->AccessibleName = nullptr;
			resources->ApplyResources(this->labCountryCodeL, L"labCountryCodeL");
			this->labCountryCodeL->Name = L"labCountryCodeL";
			// 
			// labProductNameLimit
			// 
