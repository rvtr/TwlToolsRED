/* 
 [ROM用] make_sdtad_table.exe -dir test-tad -odir [dir] -var MAKEROM_TAD_ROMFILES -fdir tads -mk Makefile.inc
 [SD用] make_sdtad_table.exe -sd -dir test-tad -odir [dir] -fdir sdtads
