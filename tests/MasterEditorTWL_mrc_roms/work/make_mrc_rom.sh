...
cp $usr_card $outdir/touch_try_ds_card02.srl
$maker $usr_card $outdir/touch_try_ds_card04.srl 1D -e 0 -f
$maker $usr_card $outdir/touch_try_ds_card05.srl 1D -e 1 -f
$maker $usr_card $outdir/touch_try_ds_card06.srl 1B4 -4 -e 3 -f
